 ...
 * based on SSD1306/SH1106 drivers using SPI to communicate.
...
//#include <Adafruit_SH110X.h>   // uncomment this line if you are using an SH1106 based display
//#include <Adafruit_SSD1306.h>  // uncomment this line if you are using an SSD1306 based display
...
// uncomment the below line if you are using an SH1106 based display
//Adafruit_SH1106G display = Adafruit_SH1106G(128, 64,OLED_MOSI, OLED_CLK, OLED_DC, OLED_RST, OLED_CS);

// uncomment the below line if you are using an SSD1306 based display
...
void setup() {
  ...
  Serial.begin(115200); 
  //display.begin(SSD1306_SWITCHCAPVCC);              // uncomment if you are using an SSD1306 based display                           
  //display.begin(0, true);                           // uncomment if you are using an SH1106 based display 
